...
const VENUES = [
  {
    ...
    lines: [
      'Edloor Road',
      'Kattangur',
      'Dist: Nalgonda, Telangana',
    ],
    mapSrc:
      'https://maps.google.com/maps?q=M.S.R.+Gardens,Edloor+Road,Kattangur,Nalgonda,Telangana&z=14&t=k&output=embed',
    mapsHref:
      'https://maps.google.com/?q=M.S.R.+Gardens,Edloor+Road,Kattangur,Nalgonda,Telangana',
  },
]

...
const EVENTS = [
  {
    ...
    date: 'Thursday, 11:00 AM Onwards',
    venue: 'M.S.R. Gardens, Edloor Road, Kattangur, Nalgonda',
    description: 'Dhanishta Nakshatram, Thula Lagnam — the sacred moment of union.',
  ...
  },
  {
    ...
    year: 2026,
    title: 'Lunch',
    date: 'Following the Wedding Ceremony',
    venue: 'M.S.R. Gardens, Edloor Road, Kattangur, Nalgonda',
    description: 'Join us for a festive lunch to celebrate the new beginning.',
